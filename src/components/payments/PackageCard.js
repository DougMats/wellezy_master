...
// "airplaneTicket":"ticket de avión",
// "transport":"transporte",
// "homeRecovery":"casa de recuperación",
    ...
    <View style={styles.package}>
      ...
      <View style={styles.packageBody}>
        ...
        {open &&
          <View style={styles.includesWrap}>
            <Text style={styles.includesTitle}>{t("ThisPackageIncludes")}</Text>
            {props.data.items.map((i, key) => {
              return (
                <View key={key} style={styles.include}>
                  ...
                  <Text style={styles.includeText}>{t(`${i.type}`)}</Text>
                </View>
              )
            })}
          </View>
      ...
      <View style={styles.packageFoot}>
        <TouchableOpacity onPress={() => props.goToScreen("PackageDescription", props.data)} style={styles.packageFootBtn}>
          <Text style={styles.packageFootBtnText}>{t("seedetails")}</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
