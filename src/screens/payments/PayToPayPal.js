...
import { SafeAreaView, StatusBar, View, Text, StyleSheet, TextInput, TouchableOpacity, Image, ScrollView, ActivityIndicator, Alert, Linking, Picker, ActionSheetIOS, Button, Modal } from 'react-native';
...
function PayToPayPal(props) {
  ...
  //console.log("pay to card ----->", props.route.params.data)
      ...
      <ScrollView scrollEventThrottle={16}>
        <View style={styles.card}>
          ...
          <View style={styles.inputView} >
            ...
            <TextInput
              style={styles.inputText} placeholder="EJ: Aaron Navas" placeholderTextColor="#ccc" onChangeText={text => setNameCard(text)} value={NameCard} />
          </View>
          ...
          <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "center", alignItems: "center" }}>
            ...
            <Text style={{ width: "80%", textAlign: "justify", margin: 8, fontSize: 14, color: color_grey_half, lineHeight: 20 }}>
