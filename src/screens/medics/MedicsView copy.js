...
function MedicsView(props) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: color_screen }}>
      <StatusBar backgroundColor={"transparent"} barStyle={openup?'light-content':'dark-content'} translucent />
...
<TouchableOpacity onPress={() => props.back()}><Icon name="arrow-ios-back-outline" width={30} height={30} fill={color_fifth} /></TouchableOpacity>
...
<ScrollView horizontal scrollEventThrottle={16} showsHorizontalScrollIndicator={false}>
  <TouchableOpacity style={{}}><Text style={{}}>...</Text></TouchableOpacity>
  <TouchableOpacity style={{}}><Text style={{}}>...</Text></TouchableOpacity>
  <TouchableOpacity style={{}}><Text style={{}}>...</Text></TouchableOpacity>
  <TouchableOpacity style={{}}><Text style={{}}>...</Text></TouchableOpacity>
</ScrollView>
 ...
 */}
        ...
        {Load === true && <ActivityIndicator size="large" color={color_primary} animating={true} style={{ marginTop: 100 }} />}
